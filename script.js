...
function buildTweetEmbedUrl(tweetId) {
  return `https://platform.twitter.com/embed/Tweet.html?id=${tweetId}&theme=dark&chrome=nofooter`;
}
...
function createCard(item) {
  ...
  if (item.imgUrl) {
    ...
    iframe.src = buildTweetEmbedUrl(item.id);
